...
const Hero = () => {
  return (
    <section className='relative z-10 flex h-screen flex-col items-center justify-center overflow-hidden bg-white px-5 pb-16 pt-[120px] dark:bg-black md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]'>
